          ...
          <div className="course-main-content">
            <div className="container-fluid p-4">
              ...
              <form className="assignment-form">
                <div className="row mb-3">
                  <div className="col-12">
                    ...
                    <input 
                      ...
                      id="assignmentName" 
                      name="assignmentName" 
                      defaultValue="A1 - OOP Design Patterns"
                    />
                  </div>
                </div>
                ...
                <div className="row mb-3">
                  <div className="col-12">
                    ...
                    <textarea 
                      ...
                      name="description" 
                      rows="4"
                      defaultValue="Implement object-oriented design patterns including Singleton, Factory, Observer, and Strategy patterns in Java or Python."
                    ></textarea>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-12">
                    <button type="button" className="btn btn-secondary me-2" onClick={() => window.location.href='/kambaz/courses/5678/assignments'}>
                      Cancel
                    </button>
