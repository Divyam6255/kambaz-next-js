...
export default function AssignmentsPage() {
  ...
  const handleDeleteAssignment = async (assignmentId) => {
    if (confirm('Are you sure you want to delete this assignment?')) {
      await dispatch(deleteAssignmentThunk({ courseId: '9999', assignmentId }));
    }
  };
      ...
      <main className="main-content">
        ...
        <div className="course-layout">
          <div className="course-nav-sidebar" style={{ backgroundColor: 'white' }}>
            ...
            <div className="course-nav-item">
              <a href="/kambaz/courses/9999/quizzes">Quizzes</a>
            </div>
            <div className="course-nav-item">
              <a href="#">Grades</a>
            </div>
              ...
              {courseFromRedux?.assignments?.map(assignment => (
                <div className="assignment-item" key={assignment.id} style={{ position: 'relative' }}>
                  <div className="assignment-info">
                    <h4>
                      <a href="/kambaz/courses/9999/assignments/editor" style={{ color: '#007bff', textDecoration: 'none' }}>
                        {assignment.title}
                      </a>
                    </h4>
